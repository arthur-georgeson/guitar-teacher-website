  ...
  return (
    <div className="about">
      ...
      <div className="card">
        ...
        <p className="lead">
          Playing guitar is how I relax and express myself. Over the years I’ve developed tips and techniques that have helped me progress — and I love sharing these with students.
        </p>
       <p className="lead">
